...
namespace SwiftPay.Migrations
{
    ...
    [Migration("20260731080927_InitialCreate")]
            ...
            modelBuilder.Entity("SwiftPay.FXModule.Api.Models.RateLock", b =>
                {
                    ...
                    b.ToTable("RateLock", (string)null);
                });
            ...
            modelBuilder.Entity("SwiftPay.Models.ReconciliationRecord", b =>
                {
                    ...
                    b.ToTable("ReconciliationRecord", (string)null);
                });
            ...
            modelBuilder.Entity("SwiftPay.Models.SettlementBatch", b =>
                {
                    ...
                    b.ToTable("SettlementBatch", (string)null);
                });
            ...
            modelBuilder.Entity("SwiftPay.Domain.Remittance.Entities.Amendment", b =>
                {
                    ...
                    b.HasOne("SwiftPay.Models.User", "RequestedByUser")
                        .WithMany()
