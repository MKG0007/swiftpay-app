...
const NOTIF_PATHS = {
  ...
  Agent:      '/customer/notifications',
  Compliance: '/customer/notifications',
  Ops:        '/customer/notifications',
  Treasury:   '/customer/notifications',
}
...
export default function Navbar({ sidebarCollapsed }) {
  ...
  // Reset badge when user visits any notifications page
  useEffect(() => {
  ...
  const notifPath = NOTIF_PATHS[role] ?? '/customer/notifications'
